...
RUN FILES="$(gofumports -l -local github.com/talos-systems/go-debug .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'gofumports -w -local github.com/talos-systems/go-debug .':\n${FILES}"; exit 1)
