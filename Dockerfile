...
RUN FILES="$(goimports -l -local github.com/siderolabs/go-debug/ .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'goimports -w -local github.com/siderolabs/go-debug/ .':\n${FILES}"; exit 1)
